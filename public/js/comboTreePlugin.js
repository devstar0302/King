...
;(function ( $, window, document, undefined ) {
    ...
    ComboTree.prototype.createSourceItemHTML = function (sourceItem) {
        ...
        if (this.options.isMultiple)
            ...
            itemHtml += '<span data-id="' + sourceItem.id + '" class="comboTreeItemTitle" data-value="'+ sourceItem.value + '">' + sourceItem.title + '</span>';
    ...
    ComboTree.prototype.singleItemClick = function (ctItem) {
        ...
        if(this._selectedItem.id == "undefined") {
            if($(ctItem).closest('li').hasClass('ComboTreeItemParent')) {
                this.toggleSelectionTree($(ctItem).closest('li'));
                return;
            }
        } else {

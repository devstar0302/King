                    ...
                    <div class="card-body">
                        ...
                        <div class="row" style="padding-bottom: 10px;">
                            <div style="float: left; padding: 0 15px;">
                                <input type="text" class="form-control" name="date-range" value="" placeholder="{{__('Select date range')}}" style="height: 35px;">
                            </div>
                            ...
                            <div style="float: right;" class="{{$mPaginateClass}}">

                                <a href="javascript;" class="btn-blue btn_con" id="btn_next" style="width: 75px; text-align: center; float: right;">{{ __('Next') }}</a>

        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card malfunctions <?php echo e($user_role); ?>" id="pdf-container">
                    ...
                    <h5 style="padding-right: 43px; margin-bottom: -21px"><?php echo e(__('To')); ?></h5>
                    <div class="card-body row total-summary">
                        <div class="col-md-4">
                            <ul class="company">
                                ...
                                <li>
                                <span><?php echo e((isset($malfunction->data['site']) ?
                                    $malfunction->data['site'] : '') . (isset($malfunction->data['subsite']) ? (" / " . $malfunction->data['subsite']) :
                                    '')); ?>

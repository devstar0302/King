...
<style>
    ...
    #companyRepresentativeName::placeholder {
        font-style: normal;
    }
</style>
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="row" style="direction:ltr;">
                    ...
                    <div class="input-group">
                        ...
                        <div class="select-editable">
                            <select class="custom-select" id="user-name-select"
                                    aria-label="Example select with button addon" dir="rtl">
                                <option selected><?php echo e(__('Name')); ?></option>
                            </select>
                            <input type="text" name="format" value="" id="format" style="text-align: right;" placeholder="<?php echo e(__('Name')); ?>"/>
                        </div>
                ...
                <div class="col-md-8">
                    <div class="input-group">
                        <textarea id="companyRepresentativeName" rows="1" class="form-control" style="height: 37px; font-size: 14.4px; text-align: right;" placeholder="<?php echo e(__('Company representative name')); ?>"></textarea>

                        <select class="custom-select" id="sub-site-select" aria-label="Example select with button addon" dir="rtl" disabled>
                        ...
                        <select class="custom-select" id="site-select" aria-label="Example select with button addon" dir="rtl">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table id="users-table" class="display" style="width:70%; direction:ltr;">
                        <thead>
                            <tr>

        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card malfunctions <?php echo e($user_role); ?>" id="pdf-container">
                    ...
                    <h5 style="padding-right: 43px; padding-left: 43px; margin-bottom: -21px; font-size: 0.9rem;"><?php echo e(__('To')); ?></h5>
                    <div class="card-body row total-summary">
                        <div class="col-md-4">
                            <ul class="company">
                                <li>
                                <span>
                                    <?php echo e(isset($malfunction->data['company_representative']) ?
                                        $malfunction->data['company_representative'] : ''); ?>

                                </span>
                                </li>
                                <li id="print_sub">
                                <span><?php echo e((isset($malfunction->data['site']) ? $malfunction->data['site'] : '') . (isset($malfunction->data['subsite']) ? (" / " . $malfunction->data['subsite']) : '')); ?>
                        ...
                        <div class="col-md-4">
                            <ul class="employe">
                                ...
                                <li id="print_date"><?php echo e(__('Date')); ?>: <?php echo e(isset($malfunction->data['date']) ? $malfunction->data['date'] : '--/--/----'); ?></li>
                    ...
                    <div class="card-body details">
                            ...
                            <table class="table table-hover" border="1">
                                ...
                                <?php if(isset($malfunction->data['categories'])): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><b><?php echo e(isset($malfunction->data['calculate']['total']) && strpos($malfunction->data['calculate']['total'], '%') !== false ? $malfunction->data['calculate']['total'] : "---"); ?></b></td>
                                    </tr>
                                <?php endif; ?>
                                </tbody>
                            </table>
                        ...
                        <div class="malfunctions-item other">
                            <h5><b>7. <?php echo e(App::getLocale() == 'en' ? 'Summary & Recommendations' : 'מסקנות והמלצות'); ?></b></h5>
                            <?php if(isset($malfunction->data['malfunction-list'])): ?>
                        ...
                        <div class="malfunctions-item other">
                            <h5 style="font-size: 0.9rem;"><?php echo e(__('Sincerely')); ?>,</h5>
                            <h5 style="font-size: 0.9rem;"><?php echo e(isset($malfunction->data['employee_name']) ? $malfunction->data['employee_name'] : ""); ?></h5>
                        </div>
                    </div>

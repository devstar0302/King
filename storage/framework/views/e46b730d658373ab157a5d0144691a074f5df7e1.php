        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="text-center text-primary"><?php echo e(__('Register')); ?></h3>
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label <?php echo e(app()->getLocale() == 'he' ? 'text-md-left' : 'text-md-right'); ?>"><?php echo e(__('Confirm Password')); ?></label>

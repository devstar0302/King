            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="card malfunctions <?php echo e($user_role); ?>">
                        ...
                        <div class="card-body">
                            <form action="<?php echo e(action('MalfunctionController@update', $malfunction_id)); ?>" method="POST" id="malfunction-form" style="width:100%;">
                                ...
                                <div class="col-md-12 malfunction-summary malfunction-other hidden">
                                    <div><h4 class="malfunction-heading">7. <?php echo e(App::getLocale() == 'en' ? 'Summary & Recommendations' : 'מסקנות והמלצות'); ?></h4>
                                    </div>

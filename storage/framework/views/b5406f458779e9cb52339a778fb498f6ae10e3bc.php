              ...
              <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr id="<?php echo e($user->id); ?>">
                  <td style="display: flex; align-items: center;">
                    <button class="btn btn-default mail-btn" onclick="mailUser(<?php echo e($user->id); ?>)"><i class="far fa-envelope"></i></button>
                    <button class="btn btn-default edit-btn"><i class="fas fa-edit"></i></button>
                    <button class="btn btn-danger" onclick="deleteUser(<?php echo e($user->id); ?>)"><i class="fas fa-trash-alt"></i></button>
                    <button class="btn btn-success update-btn"><?php echo e(__('Save')); ?></button>
                  </td>
                  ...
                  <td data-title="role" data-roleid="<?php echo e($user->role->id); ?>"><?php echo e(__($user->role->title)); ?></td>
                </tr>
    ...
    <script>
      ...
      $(".update-btn").on('click', function() {
        ...
        $.ajax({
          ...
          data: {"_token": "<?php echo e(csrf_token()); ?>", "pwd":data.pwd, "email":data.email, "name":data.name, "role":data.role},
      ...
      $(".edit-btn").on('click', function() {
        ...
        let roles = ["Admin","Client","Contractor","Employee"];
        ...
        // roleEl.html("<select name='role'><option value='1'>admin</option><option value='2' selected>user</option></select>");
        // console.log(data);
      });

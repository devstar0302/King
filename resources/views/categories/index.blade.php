                                    ...
                                    <table class="table" id="category_table" border="1">
                                        <tbody>
                                            <tr style="background-color: #fff;">
                                                ...
                                                <td style="width:30%;">
                                                    <span class="item-score category-total-score">{{ $category->paragraphs->sum('score')}}</span>
                                                </td>
                                            ...
                                            <tbody data-category-id="{{$category->id}}">
                                                @foreach($category->paragraphs as $paragraph)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="30%"><a class="item-name" href="{{
                                                            action('ParagraphController@edit', [$paragraph->id, 'number' => $categoryNumber.'.'.$counter])
                                                        }}">{{ $paragraph->name }}</a></td>

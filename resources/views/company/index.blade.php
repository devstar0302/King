    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="row" style="direction:ltr;">
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <div class="select-editable">
                            ...
                            <input type="text" name="format" value="" id="format" style="text-align: right;" placeholder="{{__('Name')}}"/>
                        </div>
                ...
                <div class="col-md-8">
                    <div class="input-group">
                        <textarea id="companyRepresentativeName" rows="1" class="form-control" style="height: 37px; font-size: 14.4px; text-align: right;" placeholder="{{__('Company representative name')}}"></textarea>
